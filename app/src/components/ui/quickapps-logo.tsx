const DokployLogo = ({ ...props }: React.ComponentProps<"svg">) => (
  ...
  >
    ...
    <defs>
      ...
      >
        <stop stopColor="#31CBED" />
        <stop offset={1} stopColor="#FAFD63" />
      </linearGradient>
    </defs>
  </svg>
)
